<div class="mt-6 grid grid-cols-2 gap-2">
    <div class="border border-stone-700  rounded">
        ...
        <form class="p-4 space-y-4">
            <div class=" flex flex-col">
                <label class="text-stone-500 mb-1">Email</label>
                <input
                    type="email"
                    name="email" required
            ...
            <div class="flex flex-col">
                <label class="text-stone-500 mb-1">Senha</label>
                <input
                    type="password"
                    name="senha" required
                    class="border-stone-800 border-2 rounded-md bg-stone-900 text-sm focus:outline-none px-2 py-1" />
    ...
    <div class="border border-stone-700  rounded">
        ...
        <form class="p-4 space-y-4" method="POST" action="/registrar">
            ...
            <?php endif; ?>
            <div class=" flex flex-col">
                <label class="text-stone-500 mb-1">Nome</label>
                <input
                    type="text"
                    name="nome" required
                    class="border-stone-800 border-2 rounded-md bg-stone-900 text-sm focus:outline-none px-2 py-1" />
            ...
            <div class=" flex flex-col">
                <label class="text-stone-500 mb-1">Confirme seu Email</label>
                <input
                    type="email"
